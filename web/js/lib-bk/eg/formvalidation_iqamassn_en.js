...
jQuery( "#iqamassn-form" ).validate({
    ...
    messages:
    {
        ...
        //},
        iqamassn_new: 'Please enter a valid 14 digits Iqama Id/SSN for Egypt',
        confirm_iqamassn_new:  'Please enter a valid 14 digits Iqama Id/SSN for Egypt',
        comment_iqamassn: "please enter comments"
    }
});
...
jQuery( "#iqamassn-submit" ).click(function()
{
    ...
    if( (jQuery("#iqamassn_new").val() !="") &&  (jQuery("#confirm_iqamassn_new").val() !=""))
    {
        if (jQuery("#iqamassn_new").val() != jQuery("#confirm_iqamassn_new").val()) {
            ...
            jQuery("#confirm_iqamassn_new").after('<label id="confirm_iqamassn_new-error" class="error" for="confirm_iqamassn_new">Your new Iqama Id/SSN and confirm new Iqama Id/SSN must be same</label>');
            return false;
        }
    }
